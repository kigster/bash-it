...
. "$BASH_IT/themes/powerline-multiline-root/powerline-multiline-root.base.bash"

PROMPT_CHAR=${POWERLINE_PROMPT_CHAR:="${bldred} ${clr}"}
...
USER_INFO_THEME_PROMPT_COLOR=160
...
POWERLINE_LEFT_PROMPT="user_info chef"
POWERLINE_RIGHT_PROMPT="cwd clock"
